-- =============================================================================
-- Migration: RPC relatorio_caminhao_periodo
-- Story: 23.6 — Relatorio por caminhao com custo/km, margem e comparativo
-- Timestamp: 20260414320000
--
-- BLOCKER: Story 18.1 (Draft) — campos ipva/crlv/proxima_revisao_km NAO
-- existem em caminhao. Secao proximos_alertas omitida deliberadamente.
-- =============================================================================
...
BEGIN
  -- -----------------------------------------------------------------------
  -- 1. Resolve caminhao + empresa (RLS will filter)
  -- -----------------------------------------------------------------------
  ...
  -- -----------------------------------------------------------------------
  -- 4. Custo por km (centavos/km) — divisao por zero segura
  -- -----------------------------------------------------------------------
  v_custo_por_km := CASE
  ...
  -- -----------------------------------------------------------------------
  -- 5. Margem percentual — divisao por zero segura
  -- -----------------------------------------------------------------------
...
COMMENT ON FUNCTION relatorio_caminhao_periodo IS 'Retorna relatorio completo de um caminhao em um periodo: receita, custos, margem, custo/km, ranking na frota. SECURITY INVOKER: herda RLS do caller. Depende de idx_viagem_caminhao_saida.';
