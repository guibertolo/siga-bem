...
import type { EmpresaOption } from '@/components/empresa/EmpresaSelectForCreate';

interface CadastroCaminhaoClientProps {
  multiEmpresa: {
...
export function CadastroCaminhaoClient({ multiEmpresa }: CadastroCaminhaoClientProps) {
    ...
    <>
      ...
      {multiEmpresa && (
        <EmpresaSelectForCreate
          empresas={multiEmpresa.empresas}
          activeEmpresaId={multiEmpresa.activeEmpresaId}
        />
      )}
